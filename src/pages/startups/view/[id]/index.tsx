...
function StartupViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<StartupInterface>(
    ...
    () =>
      getStartupById(id, {
        relations: ['user', 'collaborator', 'feedback'],
      }),
  );
              ...
              {hasAccess('collaborator', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/collaborators/create?startup_id=${data?.id}`}>
              ...
              {hasAccess('feedback', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/feedbacks/create?startup_id=${data?.id}`}>
                      <Button colorScheme="blue" mr="4" as="a">
                        Create
                      </Button>
                    </NextLink>
